...
import (
	...
	ethcdc "github.com/omexapp/omexchain/app/codec"
)
...
// file.
func (app *OMExChainApp) ExportAppStateAndValidators(
...
func (app *OMExChainApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
