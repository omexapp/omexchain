...
import (
	...
	evmtypes "github.com/omexapp/omexchain/x/evm/types"

	"github.com/omexapp/omexchain/app/ante"
	omexchaincodec "github.com/omexapp/omexchain/app/codec"
	omexchain "github.com/omexapp/omexchain/app/types"
	"github.com/omexapp/omexchain/x/ammswap"
	"github.com/omexapp/omexchain/x/backend"
	commonversion "github.com/omexapp/omexchain/x/common/version"
	"github.com/omexapp/omexchain/x/debug"
	"github.com/omexapp/omexchain/x/dex"
	dexclient "github.com/omexapp/omexchain/x/dex/client"
	distr "github.com/omexapp/omexchain/x/distribution"
	"github.com/omexapp/omexchain/x/evidence"
	"github.com/omexapp/omexchain/x/evm"
	"github.com/omexapp/omexchain/x/farm"
	farmclient "github.com/omexapp/omexchain/x/farm/client"
	"github.com/omexapp/omexchain/x/genutil"
	"github.com/omexapp/omexchain/x/gov"
	"github.com/omexapp/omexchain/x/gov/keeper"
	"github.com/omexapp/omexchain/x/order"
	"github.com/omexapp/omexchain/x/params"
	paramsclient "github.com/omexapp/omexchain/x/params/client"
	"github.com/omexapp/omexchain/x/slashing"
	"github.com/omexapp/omexchain/x/staking"
	"github.com/omexapp/omexchain/x/stream"
	"github.com/omexapp/omexchain/x/token"
...
const appName = "OMExChain"

var (
	// DefaultCLIHome sets the default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.omexchaincli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.omexchaind")
...
var _ simapp.App = (*OMExChainApp)(nil)

// OMExChainApp implements an extended ABCI application. It is an application
// that may process transactions through Ethereum's EVM running atop of
// Tendermint consensus.
type OMExChainApp struct {
	*bam.BaseApp
	cdc *codec.Codec
...
// NewOMExChainApp returns a reference to a new initialized OMExChain application.
func NewOMExChainApp(
	logger log.Logger,
	db dbm.DB,
	...
	if err != nil {
		logger.Error(fmt.Sprintf("the config of OMExChain was parsed error : %s", err.Error()))
		panic(err)
	}

	cdc := omexchaincodec.MakeCodec(ModuleBasics)

	// NOTE we use custom OMExChain transaction decoder that supports the sdk.Tx interface instead of sdk.StdTx
	...
	// use custom OMExChain account for contracts
	app.AccountKeeper = auth.NewAccountKeeper(
		cdc, keys[auth.StoreKey], app.subspaces[auth.ModuleName], omexchain.ProtoAccount,
	)
...
func (app *OMExChainApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker updates every begin block
func (app *OMExChainApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker updates every end block
func (app *OMExChainApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

func (app *OMExChainApp) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
...
func (app *OMExChainApp) syncTx(txBytes []byte) {
...
func (app *OMExChainApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *OMExChainApp) LoadHeight(height int64) error {
	return app.LoadVersion(height, app.keys[bam.MainStoreKey])
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *OMExChainApp) ModuleAccountAddrs() map[string]bool {
...
func (app *OMExChainApp) BlacklistedAccAddrs() map[string]bool {
...
func (app *OMExChainApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
func (app *OMExChainApp) GetKey(storeKey string) *sdk.KVStoreKey {
	return app.keys[storeKey]
}

// Codec returns OMExChain's codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *OMExChainApp) Codec() *codec.Codec {
	return app.cdc
}
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *OMExChainApp) GetSubspace(moduleName string) params.Subspace {
