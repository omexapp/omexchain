...
// transactions. There should only be a single implementation in OMExChain. For
// the purposes of OMExChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: OMExChain will distribute the fees out to validators, so the structure
