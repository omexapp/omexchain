...
import (
	...
	swap "github.com/omexapp/omexchain/x/ammswap"
	swaptypes "github.com/omexapp/omexchain/x/ammswap/types"
	"github.com/omexapp/omexchain/x/farm/keeper"
	"github.com/omexapp/omexchain/x/farm/types"
...
type testContext struct {
	...
	addrList          []sdk.AccAddress // 1000 omt per address
	handler           sdk.Handler
}
	...
	tests := []testCaseItem{
		...
		},
		{
			...
			expectedErr: errors.New(
				"insufficient coins: insufficient funds: insufficient account funds; 89900.000000000000000000aab,101.000000000000000000ammswap_aab_ccb,89900.000000000000000000ccb,100000.000000000000000000ddb,1000.000000000000000000omt < 1.000000000000000000fff",
			),
		},
		{
...
func TestHandlerMsgDestroyPool(t *testing.T) {
	...
	tests := []testCaseItem{
		...
		},
		{
			...
			verification: verification,
			expectedErr:  types.ErrInvalidPoolOwner("omexchain15ky9du8a2wlstz6fpx3p4mqpjyrm5cgpq6kh8f", "abc"),
		},
		{
			caseName: "failed. insufficient fee coins",
			preExec: func(t *testing.T, tCtx *testContext) interface{} {
			...
			getMsg:       normalGetDestroyPoolMsg,
			verification: verification,
			expectedErr: errors.New("insufficient coins: insufficient funds: insufficient account funds; 10.000000000000000000omt < 1.000000000000000000fff"),
		},
		{
...
func TestHandlerMsgUnlock(t *testing.T) {
	...
	tests := []testCaseItem{
		...
		},
		{
			...
			getMsg:       normalGetUnlockMsg,
			verification: verification,
			expectedErr:  types.ErrNoLockInfoFound("omexchain15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqavzz6m", "abc"),
		},
		{
			caseName: "failed. The coin name should be %s, not %s",
			preExec:  preExec,
