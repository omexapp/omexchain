...
import (
	...
	orderKeeper "github.com/omexapp/omexchain/x/order/keeper"
	tokenKeeper "github.com/omexapp/omexchain/x/token"
	token "github.com/omexapp/omexchain/x/token/types"
	"github.com/stretchr/testify/require"
	"github.com/tendermint/tendermint/crypto/secp256k1"
)

func TestGenerateTx(t *testing.T) {
	txbldr := auth.NewTxBuilder(auth.DefaultTxEncoder(auth.ModuleCdc), 1, 2, 3, 4, false, "omexchain", "memo", nil, nil)
