...
import (
	...
	omexchaincfg "github.com/cosmos/cosmos-sdk/server/config"
...
// nolint
const (
	EngineTypeSqlite = omexchaincfg.BackendOrmEngineTypeSqlite
	EngineTypeMysql  = omexchaincfg.BackendOrmEngineTypeMysql
)

// nolint
type OrmEngineInfo = omexchaincfg.BackendOrmEngineInfo
