...
import (
	...
	apptypes "github.com/omexapp/omexchain/app/types"
)
...
func TestHasSufCoins(t *testing.T) {
	initConfig()
	addr, err := sdk.AccAddressFromBech32("omexchain18mxjm0knqjpkaxk2zd2jr67pgrd8c0ct0tycvl")
	require.Nil(t, err)
...
func TestBlackHoleAddress(t *testing.T) {
	...
	a := addr.String()
	fmt.Println(a)
	require.Equal(t, addr.String(), "omexchain1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqupa6dx")
}
