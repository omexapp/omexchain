...
import (
	...
	"github.com/omexapp/omexchain/x/gov/client/utils"

	"github.com/omexapp/omexchain/x/gov/types"
...
Example:
$ %s query gov proposals --depositor omexchain1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ %s query gov proposals --voter omexchain1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
...
Example:
$ %s query gov vote 1 omexchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query gov deposit 1 omexchain1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.ClientName,
			),
		),
