...
const DefaultTokenOwner = "omexchain10q0rk5qnyag7wfvvt7rtphlw589m7frsku8qc9"
...
func defaultGenesisState() GenesisState {
	return GenesisState{
		...
		Tokens:       []types.Token{defaultGenesisStateOMT()},
		LockedAssets: nil,
		LockedFees:   nil,
	}
}

// default omt information
func defaultGenesisStateOMT() types.Token {
