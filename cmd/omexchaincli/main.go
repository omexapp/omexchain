...
import (
	...
	tokencmd "github.com/omexapp/omexchain/x/token/client/cli"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "omexchaincli",
		Short: "Command line interface for interacting with omexchaind",
	}
	...
	// Add flags and prefix all env exposed with OMEXCHAIN
	executor := cli.PrepareMainCmd(rootCmd, "OMEXCHAIN", app.DefaultCLIHome)
