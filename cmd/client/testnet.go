...
import (
	...
	stakingtypes "github.com/omexapp/omexchain/x/staking/types"

	"github.com/omexapp/omexchain/app/crypto/hd"
	ethermint "github.com/omexapp/omexchain/app/types"
...
func TestnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for an OMExChain testnet",
		Long: `testnet will create "v" number of directories and populate each with
necessary files (private validator, genesis, config, etc.).

Note, strict routability for addresses is turned off in the config file.`,

		Example: "omexchaind testnet --v 4 --keyring-backend test --output-dir ./output --starting-ip-address 192.168.10.2",
	...
	cmd.Flags().String(flagNodeDaemonHome, "omexchaind", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "omexchaincli", "Home directory of the node's cli configuration")
...
func InitTestnet(
	...
	if chainID == "" {
		chainID = fmt.Sprintf("omexchain-%d", tmrand.Int63n(9999999999999)+1)
	}
